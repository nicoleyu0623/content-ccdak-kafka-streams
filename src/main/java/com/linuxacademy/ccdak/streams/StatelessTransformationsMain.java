...
public class StatelessTransformationsMain {
    ...
    public static void main(String[] args) {
        ...
        // one containing all records where the key begins with "a",
        ...
        //----------------------------------------------------------------------------------//
        // 2. filter
        // Remove any records from the "a" stream
        // where the value does not also start with "a".
        aKeysStream = aKeysStream.filter((key, value) -> value.startsWith("a"));

        // 3. flatMap
        // For the "a" stream, convert each record into two records,
        // one with an uppercased value
        // and one with a lowercased value.
        ...
        aKeysStream = aKeysStream.map((key, value)
                -> KeyValue.pair(key.toUpperCase(), value));
        ...
        // FINAL: transform the data to a topic
